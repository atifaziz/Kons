...
if not defined COMMIT_UNIX_TIME echo Unable to determine the time of commit. & exit /b 1
...
call build ^
  ...
  && NuGet pack Kons.nuspec -Symbol -Properties "%VERSION_SUFFIX%;%REPO_COMMIT%" -OutputDirectory dist
goto :EOF
